...
namespace Xft
{
    [AddComponentMenu("PlayFam/Player/Weapon Trail")]
    public class XWeaponTrail : MonoBehaviour
    {
       ...
       // #endregion
        ...
        public void Activate(Texture2D texture, int length, Color color)
        {
			...
			mMeshObj.GetComponent<Renderer>().material.SetTexture("_MainTex", texture);
        }
        ...
        void InitMeshObj()
        {
            ...
            mMeshObj = new GameObject("_trai : " + Time.time);
			//mMeshObj.transform.parent = XPlayerInformation.Instance.transform;
            ...
            mr.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off; //edit BYN
